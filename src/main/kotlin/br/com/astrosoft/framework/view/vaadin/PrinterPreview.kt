...
class PrinterPreview(val showPrinter: Boolean = true, val printerUser: List<String>, val rota: Rota?, val loja: Int,
                     val showPrintBunton: Boolean = true, val actionSave: ((SubWindowPrinter) -> Unit)?,
                     val printEvent: (impressora: String) -> Unit) : IPrinter {
