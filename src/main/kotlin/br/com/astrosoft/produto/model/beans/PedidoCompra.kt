...
class PedidoCompra(val loja: Int,
  ...
  fun produtos(marca: EMarcaNota) = saci.findProdutoPedidoCompra(this, marca, userLocais())
...
data class FiltroPedido(val storeno: Int, val nota: String, val marca: EMarcaNota) {
  val nfno: Int
