...
data class DivergenciaInventario(val codigo: String, val quantidadeExcel: BigDecimal?, val quantidadeSped: BigDecimal?,
...
fun valoresIguaisComTolerancia(valorA: BigDecimal?, valorB: BigDecimal?,
                               tolerancia: BigDecimal = BigDecimal("0.01")): Boolean {
