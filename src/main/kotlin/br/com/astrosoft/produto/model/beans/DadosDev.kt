...
data class FiltroDadosDev(val loja: Int, val pesquisa: String, val dataInicial: LocalDate?, val dataFinal: LocalDate?,
                          val devolvido: Boolean = false, val localizacao: Set<String> = setOf("TODOS"),
