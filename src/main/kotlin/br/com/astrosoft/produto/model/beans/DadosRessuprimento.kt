...
data class DadosRessuprimento(val loja: Int, val lojaRessuprimento: Int, val pedido: Int, val data: LocalDate?,
                              val codFornecedor: Int, val totalPedido: Double, val observacao: String,
