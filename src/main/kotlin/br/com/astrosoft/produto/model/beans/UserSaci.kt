...
class UserSaci : IUser {
  ...
  var estoqueInsereInventarioLoja by DelegateAuthorized3(151)
  var defazSolicitacao by DelegateAuthorized3(152)
  var estoqueAlteraInventarioCD by DelegateAuthorized3(153)
  var estoqueAlteraInventarioLoja by DelegateAuthorized3(154)
  ...
  var reposicaoRep by DelegateAuthorized3(158)
  ...
  var autorizaDevCliente by DelegateAuthorized3(171)
  ...
  var vendaRef: Boolean
    get() = tabVendaRef || tabResumo || tabResumoPgto || tabResumoTipo || tabResumoCartao || admin
    set(value) {
      tabVendaRef = value
      tabResumo = value
      tabResumoPgto = value
  ...
  var estoqueCD
    get() = estoqueMov || estoqueCad || estoqueCD1A || estoqueSaldo || estoqueConf || estoqueAcerto ||
            ...
            estoqueLoja || estoqueForn || controleLoja || admin
    set(value) {
      estoqueMov = value
      estoqueCad = value
      estoqueCD1A = value
  ...
  var devCliente
    get() = devCliImprimir || devCliImpresso || devCliValeTrocaProduto || devCliCredito ||
            devCliEditor || devClienteTroca || devCliSemPrd || devCliAutoriza || autorizaDevCliente || admin
    set(value) {
