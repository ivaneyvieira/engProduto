...
class ProdutoRessuprimento(var ordno: Int?, var prdno: String?, var codigo: String? = null, var grade: String?,
                           var barcodeListStr: String?, var descricao: String?, var vendno: Int?,
                           var fornecedor: String?, var typeno: Int?, var typeName: String?, var vendnoRef: String?,
                           var clno: String?, var clname: String?, var altura: Int?, var comprimento: Int?,
                           var largura: Int?, var precoCheio: Double?, var localizacao: String?, var qtPedido: Int?,
                           var qttyOriginal: Int?, var qtQuantNF: Int?, var qtRecebido: Int?, var qtEntregue: Int?,
                           var qtAvaria: Int?, var qtVencido: Int?, var vlPedido: Double?,
                           var vlQuantNF: Double?, //var vlRecebido: Double?,
                           var preco: Double?, var total: Double?, var marca: Int?, var selecionado: Int?,
                           var posicao: Int?, var estoque: Int?, var codigoCorrecao: String?,
                           var descricaoCorrecao: String?, var gradeCorrecao: String?, var numeroNota: String?,
                           var dataNota: LocalDate?, var origemSaci: String?, var origemApp: String?,
                           var validade: Int?, var vencimentoStrList: String?, var valorUltCompra: Double?,
  ...
  val qttyMax
    get() = ((this.qttyOriginal ?: 0) * 1.50).toBigDecimal().setScale(0, RoundingMode.CEILING).toInt()
