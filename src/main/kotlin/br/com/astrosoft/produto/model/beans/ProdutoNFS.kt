...
data class ProdutoNFS(var loja: Int, var pdvno: Int, var xano: Long, var nota: String?, var prdno: String?,
                      var dev: Boolean?, var devDB: Boolean?, var codigo: String?, var grade: String?,
                      var barcodeProd: String?, var barcodeStrList: String?, var descricao: String?, var vendno: Int?,
                      var fornecedor: String?, var typeno: Int?, var typeName: String?, var clno: String?,
                      var clname: String?, var altura: Int?, var comprimento: Int?, var largura: Int?,
                      var precoCheio: Double?, var ncm: String?, var local: String?, var kardec: Int?,
                      var quantidade: Int?, var quantidadeCD: Int?, var quantidadeNF: Int?, var preco: Double?,
                      var total: Double?, var gradeAlternativa: String?, var marca: Int?, var marcaImpressao: Int?,
                      var usernoExp: Int?, var usuarioExp: String?, var dataHoraExp: String?, var usernoCD: Int?,
                      var usuarioCD: String?, var dataHoraCD: String?, var usuarioSep: String?, var tipoNota: Int?,
                      var estoque: Int?, var estoqueCD: Int?, var temProduto: Boolean?, var quantDev: Int?,
                      var ni: Int?, var dataNi: LocalDate?, var qtDevNI: Int?, var seq: Int?, var lojaRsv: Int?) {
