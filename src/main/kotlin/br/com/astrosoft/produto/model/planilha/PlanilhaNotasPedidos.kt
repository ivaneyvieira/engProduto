...
class PlanilhaNotasPedidos : Planilha<NotaRecebimentoProdutoDev>("Nota Dev") {
  init {
    ...
    columnSheet(header = "V. Total", property = NotaRecebimentoProdutoDev::valorTotalDevolucao)
    ...
    columnSheet(header = "Valor ST", property = NotaRecebimentoProdutoDev::icmsSubstDevolucao)
    ...
    columnSheet(header = "V. Total", property = NotaRecebimentoProdutoDev::totalGeralDevolucao)
