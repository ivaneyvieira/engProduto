...
import br.com.astrosoft.produto.viewmodel.devForRecebe.ITabNotaNFDSTNR
import br.com.astrosoft.produto.viewmodel.devForRecebe.TabNotaNFDSTNRViewModel
...
class TabNotaNFDSTNR(val viewModel: TabNotaNFDSTNRViewModel) :
  ...
  override fun Grid<NotaRecebimentoDev>.gridPanel() {
    ...
    addColumnButton(VaadinIcon.FILE, "Arquivo", "Arquivo", configIcon = { icon, bean ->
      ...
      dlgArquivo = DlgArquivoNotaNFDSTNR(viewModel, nota)
