...
import br.com.astrosoft.produto.viewmodel.devFor2.ITabNotaEmail
...
class TabNotaEmail(val viewModel: TabNotaEmailViewModel) :
  TabPanelGrid<NotaRecebimento>(NotaRecebimento::class), ITabNotaEmail {
