...
class DevFor2View : ViewLayout<DevFor2ViewModel>(), IDevFor2View {
  ...
  override val tabNotaColetaRep = TabNotaColetaRep(viewModel.tabNotaColetaRepViewModel)
  ...
  override val tabNotaRetornoNFD = TabNotaRetornoNFD(viewModel.tabNotaRetornoNFDViewModel)
