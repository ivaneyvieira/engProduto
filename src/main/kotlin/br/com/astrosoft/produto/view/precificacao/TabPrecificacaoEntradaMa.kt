...
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoMvaMa00
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoMvaMa04
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoMvaMa07
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoMvaMa12
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoMvaMaOriginal
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoNcm
import br.com.astrosoft.produto.view.precificacao.columns.PrecificacaoColumns.promocaoNcmMa
...
import br.com.astrosoft.produto.viewmodel.precificacao.TabPrecificacaoEntradaMaViewModel
...
class TabPrecificacaoEntradaMa(val viewModel: TabPrecificacaoEntradaMaViewModel) :
      ...
      onClick {
        ...
        if (itens.isEmpty()) {
          ...
          val dialog = DialogPrecificacao(
            viewModel = viewModel, bean = BeanForm(), cardEntrada = true, cardSaida = false
          )
          dialog.open()
        }
      }
  ...
  override fun isAuthorized(): Boolean {
    ...
    return user.precificacaoEntradaMa
  }
