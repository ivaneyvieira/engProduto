...
class TabNotaEmail(val viewModel: TabNotaEmailViewModel) : TabPanelGrid<NotaRecebimentoDev>(NotaRecebimentoDev::class),
    ITabNotaEmail {
  ...
  override fun filtro(): FiltroNotaRecebimentoProdutoDev {
    return FiltroNotaRecebimentoProdutoDev(
      loja = cmbLoja.value?.no ?: 0, pesquisa = edtPesquisa.value ?: "", pago = chkPago.value ?: true
    )
  }
