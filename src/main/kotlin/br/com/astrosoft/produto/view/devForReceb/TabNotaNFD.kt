...
class TabNotaNFD(val viewModel: TabNotaNFDViewModel) : TabPanelGrid<NotaRecebimentoDev>(NotaRecebimentoDev::class),
    ITabNotaNFD {
  ...
  override fun HorizontalLayout.toolBarConfig() {
    ...
    button("Coleta") {
      ...
      this.onClick {
        viewModel.marcaSituacao(EStituacaoDev.COLETA)
      }
    }
  }
