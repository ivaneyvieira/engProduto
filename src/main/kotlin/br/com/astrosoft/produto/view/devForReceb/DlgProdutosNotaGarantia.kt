...
import br.com.astrosoft.produto.viewmodel.devForRecebe.TabNotaGarantiaViewModel
...
class DlgProdutosNotaGarantia(val viewModel: TabNotaGarantiaViewModel, var nota: NotaRecebimentoDev) {
