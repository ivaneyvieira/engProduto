...
class TabEstoqueValidadeLoja(val viewModel: TabEstoqueValidadeLojaViewModel) : TabPanelGrid<Produtos>(Produtos::class),
    ITabEstoqueValidadeLojaViewModel {
  ...
  override fun produtosSelecionados(): List<Produtos> {
    ...
    val stream: Stream<Produtos> = dataProvider.fetch(
      Query<Produtos, SerializablePredicate<Produtos>>(
        0, size, dataCommunicator.backEndSorting, dataCommunicator.inMemorySorting, null
      )
    )
