...
class DevClienteView : ViewLayout<DevClienteViewModel>(), IDevClienteView {
  ...
  override val tabDevDados = TabDevDados(viewModel.tabDevDadosViewModel)
  override val tabDevDadosImpresso = TabDevDadosImpresso(viewModel.tabDevDadosImpressoViewModel)
  ...
  override val tabDevDadosProduto = TabDevDadosProduto(viewModel.tabDevDadosProdutoViewModel)
  ...
  override val tabDevAutoriza = TabDevAutoriza(viewModel.tabDevAutorizaViewModel)
