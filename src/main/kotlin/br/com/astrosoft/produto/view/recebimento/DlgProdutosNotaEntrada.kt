...
//    val linha3 = "Natureza: $natureza"
  ...
  private fun HorizontalLayout.createGridProdutos() {
    gridDetail.apply {
      ...
      columnGrid(NotaRecebimentoProduto::valorUnit, "Valor Unitário")
      ...
      columnGrid(NotaRecebimentoProduto::valIcms, "Val. ICMS")
      columnGrid(NotaRecebimentoProduto::valIPI, "Val. IPI")
      columnGrid(NotaRecebimentoProduto::icms, "ICMS")
      columnGrid(NotaRecebimentoProduto::ipi, "IPI")
