...
class DlgProdutosDadosDev(val viewModel: TabDevDadosViewModel, val nota: DadosDev) {
  ...
  fun showDialog(onClose: () -> Unit) {
    ...
    val linha2 =
      "Tipo NF: ${nota.tipoNf}${espaco}Tipo Pgto: ${nota.tipoPgto}${espaco}Cliente: ${nota.custnoVend} - ${nota.nomeVend}"
  ...
  private fun HorizontalLayout.createGridProdutos() {
    gridDetail.apply {
      ...
      this.withEditor(classBean = DadosDevProduto::class, openEditor = {
