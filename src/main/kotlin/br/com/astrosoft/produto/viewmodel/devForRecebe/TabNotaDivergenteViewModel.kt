...
class TabNotaDivergenteViewModel(val viewModel: DevFor2ViewModel) : ITabNotaViewModel {
  val subView
    get() = viewModel.view.tabNotaDivergente
...
interface ITabNotaDivergente : ITabView {
