...
class TabNotaPedidoViewModel(viewModel: DevFor2ViewModel) : EmailViewModel(viewModel), ITabNotaViewModel {
  val subView
  ...
  fun addNota(nota: NotaRecebimentoDev, nfSaida: String) = viewModel.exec {
    try {
