...
SELECT X.storeno                                                     AS loja,
       ...
       IFNULL(S.ncm, '')                                             AS ncm,
       IFNULL(M.quantidade, ROUND(X.qtty / 1000))                    AS quantidade,
       M.quantidade                                                  AS quantidadeCD,
       ROUND(X.qtty / 1000)                                          AS quantidadeNF,
       X.preco                                                       AS preco,
       IFNULL(M.quantidade, ROUND(X.qtty / 1000)) * X.preco          AS total,
