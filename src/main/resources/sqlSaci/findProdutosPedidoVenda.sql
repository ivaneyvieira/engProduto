SELECT X.storeno                                                              AS loja,
       ...
       ROUND((IFNULL(ED.qtty_varejo, 0) + IFNULL(ED.qtty_atacado, 0)) / 1000) AS estoqueD,
       ROUND((IFNULL(EO.qtty_varejo, 0) + IFNULL(EO.qtty_atacado, 0)) / 1000) AS saldoO,
       ROUND((IFNULL(ED.qtty_varejo, 0) + IFNULL(ED.qtty_atacado, 0)) / 1000) AS saldoD,
