...
SELECT P.storeno, P.eordno AS ordno, CAST(CONCAT(P.nfno, '/', P.nfse) AS CHAR) AS numero
FROM
  sqlpdv.pxa AS P
...
SELECT P.storeno, P.eordno AS ordno, CAST(CONCAT(P.nfno, '/', P.nfse) AS CHAR) AS numero, nfno, nfse
FROM
  sqlpdv.pxa AS P
