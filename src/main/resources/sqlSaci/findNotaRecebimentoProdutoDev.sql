...
SELECT storeno                                                                                                     AS storeno,
       ...
       CAST(IF(issuedate = 0, NULL, issuedate) AS date)                                                            AS emissaoDevolucao,
...
SELECT A.invno,
       ...
       IA.nfdRecusa                                                                                     AS nfdRecusa,
       IA.nfRetorno                                                                                     AS nfRetorno,
       CAST(IF(IA.emissaoRetorno = 0, NULL, IA.emissaoRetorno) AS date)                                 AS emissaoRetorno,
       IA.niRetorno                                                                                     AS niRetorno,
...
SELECT N.storeno                                                                                            AS loja,
       ...
       DATE(IF(N.date = 0, NULL, N.date))                                                                   AS dataEntrada,
       DATE(IF(N.issue_date = 0, NULL, N.issue_date))                                                       AS emissao,
       N.invno                                                                                              AS ni,
  ...
  /*Produto*/
       ...
       nfdRecusa                                                                                            AS nfdRecusa,
       nfRetorno                                                                                            AS nfRetorno,
       emissaoRetorno                                                                                       AS emissaoRetorno,
       niRetorno                                                                                            AS niRetorno,
...
SELECT loja,
  ...
  /*Produto*/
       ...
       CAST(IF(D.duedate = 0, NULL, D.duedate) AS date) AS dataVencimentoDup,
