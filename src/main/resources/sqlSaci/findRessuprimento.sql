...
GROUP BY N.storeno, N.no, L.localizacao, notaBaixa;
...
CREATE TEMPORARY TABLE T_PEDIDO SELECT numero,
                                       fornecedor,
                                       data,
                                       comprador,
                                       localizacao,
...
WHERE (@PESQUISA = '' OR numero LIKE @PESQUISA_START OR fornecedor LIKE @PESQUISA_NUM OR comprador LIKE @PESQUISA_NUM OR
