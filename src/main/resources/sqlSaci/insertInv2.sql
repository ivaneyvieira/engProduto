...
SELECT :invno, :vendno, :ordno, 0 AS xfrno, :issue_date, CURRENT_DATE * 1 AS date, CURRENT_DATE * 1 AS comp_date, :ipi,
       ...
       0 AS auxLong10, 0 AS auxLong11, 0 AS auxLong12, 0 AS auxMoney6, 0 AS auxMoney7, 0 AS auxMoney8, 0 AS auxMoney9,
       0 AS auxMoney10, 0 AS auxMoney11, 0 AS auxMoney12, 0 AS auxMoney13, :icmsUfRemet, 0 AS fcp, 0 AS fcpSt,
       0 AS fcpStRet, 0 AS servico, 0 AS baseIss, 0 AS deducoes, 0 AS retencoes, 0 AS impImport, 0 AS issRetido,
       0 AS l1, 0 AS l2, :l3, 0 AS l4, 0 AS l5, 0 AS l6, 0 AS l7, 0 AS l8, 0 AS l9, 0 AS l10, 0 AS l11, 0 AS l12,
       0 AS l13, 0 AS l14, 0 AS l15, 0 AS l16, 0 AS l17, 0 AS l18, 0 AS l19, 0 AS l20, 0 AS l21, 0 AS l22, 0 AS l23,
       ...
       0 AS bits3, 0 AS bits4, 0 AS bits5, 0 AS s1, 0 AS s2, 0 AS s3, 0 AS s4, 0 AS s5, 0 AS s6, 0 AS s7, 0 AS s8,
       0 AS s9, 0 AS s10, 0 AS s11, 0 AS s12, 0 AS s13, 0 AS s14, 0 AS s15, 0 AS s16, 0 AS s17, 0 AS s18, 0 AS s19,
       0 AS s20, 0 AS s21, 0 AS s22, 0 AS s23, 0 AS s24, 0 AS s25, 0 AS s26, 0 AS s27, 0 AS s28, :nfname, :invse,
       '2.01.20' AS account, '' AS remarks, '' AS contaCredito, '271' AS contaDebito, '' AS nfNfse, '' AS auxStr1,
       '' AS auxStr2, '' AS auxStr3, '' AS auxStr4, '' AS auxStr5, '' AS auxStr6, '' AS c1, '' AS c2, '' AS c3,
       '' AS c4, '' AS c5, '' AS c6, '' AS c7, '' AS c8, '' AS c9, '' AS c10
FROM
  DUAL