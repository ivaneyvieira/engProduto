...
WHERE (A.storeno = IF(:loja = 0, 4, :loja))
...
WHERE (N.bits & POW(2, 4) = 0)
  ...
  AND ((N.account IN ('2.01.20', '2.01.21', '4.01.01.04.02', '4.01.01.06.04', '6.03.01.01.01', '6.03.01.01.02'))
...
SELECT N.storeno                                                   AS loja,
  ...
  /*Produto*/
       P.no                                                        AS prdno,
       TRIM(P.no)                                                  AS codigo,
       NULL                                                        AS barcodeStrList,
       NULL                                                        AS barcodeStrListEntrada,
