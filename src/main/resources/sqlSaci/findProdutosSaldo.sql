...
FROM sqldados.prd AS P LEFT JOIN sqldados.prdalq AS R
                                     ON R.prdno = P.no LEFT JOIN sqldados.spedprd AS N
                                     ON N.prdno = P.no LEFT JOIN sqldados.vend AS V
                                     ON V.no = P.mfno
WHERE
...
FROM sqldados.stk INNER JOIN T_PRD
                                 USING (prdno)
WHERE
...
FROM T_STK AS S LEFT JOIN T_LOC AS L
                              USING (prdno, gradeProduto) INNER JOIN T_PRD AS P
                              USING (prdno) LEFT JOIN T_REL AS R
...
SELECT
    ...
    prdnoRel,
    codigoRel
FROM T_PRDSTK AS S LEFT JOIN T_STKLOJA AS L
